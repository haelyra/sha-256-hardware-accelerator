...
logic [31:0] message_seed = 32'h01234675;
...
begin
 ...
 for (m = 0; m < NUM_OF_WORDS; m++) begin
 if (m == 0)
 ...
 $display("Correct H[%1d] = %x\tOutput H[%1d] = %x\tERROR", n, hh, n, dpsram[output_addr+n]);
 num_errors = num_errors + 1;
 end else begin
 $display("Correct H[%1d] = %x\tOutput H[%1d] = %x", n, hh, n, dpsram[output_addr+n]);
 end
 end
 $display("__________________________\n");
